...
const createDeckSorcerer = async (
  ...
  const desc = game.i18n.localize(`${MODULE_ID}.crew.specialty.sorcerer.description`, {
...
export default createDeckSorcerer
